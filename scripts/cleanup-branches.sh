...
then
    ...
    gh api -X DELETE repos/Relay-Launch/relaylaunch-website/git/refs/heads/copilot/fix-404-error-on-website 2>/dev/null && echo "✅ Deleted copilot/fix-404-error-on-website" || echo "⚠️  Could not delete copilot/fix-404-error-on-website"
    gh api -X DELETE repos/Relay-Launch/relaylaunch-website/git/refs/heads/copilot/fix-404-error-website 2>/dev/null && echo "✅ Deleted copilot/fix-404-error-website" || echo "⚠️  Could not delete copilot/fix-404-error-website"
    gh api -X DELETE repos/Relay-Launch/relaylaunch-website/git/refs/heads/copilot/fix-github-actions-deployment 2>/dev/null && echo "✅ Deleted copilot/fix-github-actions-deployment" || echo "⚠️  Could not delete copilot/fix-github-actions-deployment"
    gh api -X DELETE repos/Relay-Launch/relaylaunch-website/git/refs/heads/copilot/update-astro-github-pages-workflow 2>/dev/null && echo "✅ Deleted copilot/update-astro-github-pages-workflow" || echo "⚠️  Could not delete copilot/update-astro-github-pages-workflow"
    gh api -X DELETE repos/Relay-Launch/relaylaunch-website/git/refs/heads/copilot/update-astro-workflow 2>/dev/null && echo "✅ Deleted copilot/update-astro-workflow" || echo "⚠️  Could not delete copilot/update-astro-workflow"
    gh api -X DELETE repos/Relay-Launch/relaylaunch-website/git/refs/heads/copilot/update-custom-url-for-branch 2>/dev/null && echo "✅ Deleted copilot/update-custom-url-for-branch" || echo "⚠️  Could not delete copilot/update-custom-url-for-branch"
